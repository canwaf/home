...
roughdata is a reality experienced by data anlysts, scientists, and engineers. To make our work work, we make assumptions before we get to the fun stuff. We are not perfect, and we're not always right. But all analysis is iterative. We can always go back and fix things to make things better.

We can also have fun with other people's models. I haven't done much of creating generative AI models; however I've had a lot of fun with StableDiffusion and ChatGPT. I talk about ChatGPT making my life a bit easier on <a rel="me" href="https://dataare.cool/@Waf">Mastodon</a>.

### ChatGPT by OpenAI fun
